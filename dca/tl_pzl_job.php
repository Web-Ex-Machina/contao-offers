 ...
 * Table tl_pzl_job
 */
$GLOBALS['TL_DCA']['tl_pzl_job'] = array
(
	...
	(
		'dataContainer'               => 'Table',
		'ctable'                      => array('tl_pzl_job_application'),
		'switchToEdit'                => true,
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_pzl_job']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif',
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_pzl_job']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.gif',
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_pzl_job']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_pzl_job']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			),
			'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_pzl_job']['toggle'],
				'icon'                => 'visible.gif',
				'attributes'          => 'onclick="Backend.getScrollOffset();return AjaxRequest.toggleVisibility(this,%s)"',
				'button_callback'     => array('tl_pzl_job', 'toggleIcon')
			),
			'applications' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_pzl_job']['applications'],
				'href'                => 'table=tl_pzl_job_application',
				'icon'                => 'folderOP.gif'
			),
		)
	),
	...
	(
		...
		'code' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['code'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'author' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['author'],
		...
		'recipient' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['recipient'],
		...
		'title' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['title'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50', 'maxlength'=>255),
		...
		(
			'exclude'                 => true,
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['createdAt'],
			'inputType'               => 'text',
		...
		'location' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['location'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50', 'maxlength'=>255),
		...
		'remuneration' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['remuneration'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50', 'maxlength'=>255),
		...
		'status' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['status'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50', 'maxlength'=>255),
		...
		'text' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['text'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'textarea',
		...
		'published' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['published'],
			'exclude'                 => true,
			'filter'                  => true,
			'flag'                    => 1,
			'inputType'               => 'checkbox',
		...
		(
			'exclude'                 => true,
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['start'],
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'datim', 'datepicker'=>true, 'tl_class'=>'w50 wizard'),
			'sql'                     => "varchar(10) NOT NULL default ''"
		),
		...
		(
			'exclude'                 => true,
			'label'                   => &$GLOBALS['TL_LANG']['tl_pzl_job']['stop'],
			'inputType'               => 'text',
			'eval'                    => array('rgxp'=>'datim', 'datepicker'=>true, 'tl_class'=>'w50 wizard'),
			'sql'                     => "varchar(10) NOT NULL default ''"
		)
 ...
 * @author Web ex Machina <https://www.webexmachina.fr>
 */
class tl_pzl_job extends Backend
{
	/**
